...
import { SiteConfig, nowPlayingEmbedUrl } from "@/lib/siteContent";
...
/** The full home page, rendered from the admin-editable site config. */
export default function HomeContent({ config, tracks }: HomeContentProps) {
  const { artistName, bio, socials } = config;
  const NOW_PLAYING_EMBED_URL = nowPlayingEmbedUrl(config.nowPlayingUrl);
            ...
            <header className="flex flex-col items-center text-center">
              ...
              <div className="mt-4 flex items-center gap-3 md:mt-5 md:gap-5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#1DB954]/40 bg-[#1DB954]/20 text-[#1DB954] transition hover:scale-110 hover:bg-[#1DB954]/30 md:h-14 md:w-14"
                >
